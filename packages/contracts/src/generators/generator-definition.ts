...
import type { GeneratorHooks } from "./generator-hooks.js";
...
> {
  ...
  readonly schema: PromptSchema<TValues>;

  readonly templates: readonly FileDefinition<
    ResolvedTemplateVariables<TValues>
  >[];

  readonly hooks?: GeneratorHooks<TValues>;
