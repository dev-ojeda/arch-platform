...
export class PromptEngine {
    ...
    private async resolveSelectOptions<
        TValues extends NamedVariables
    >(
        field: SelectField<TValues>,
    ...
    >(
        ...
        throw new Error(
            `Field "${String(field.name)}" is required`
        )
    }
